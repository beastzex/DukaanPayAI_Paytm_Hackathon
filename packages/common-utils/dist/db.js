...
const logger = (0, logger_1.createServiceLogger)('database-service');
/**
...
class DatabaseService {
    ...
    static async query(text, params = []) {
        ...
        return this.executeInMemory(text, params);
    }
    static async transaction(callback) {
        ...
        const mockClient = {
            query: (text, params) => this.executeInMemory(text, params || []),
            release: () => { },
        };
        return callback(mockClient);
    }
    static executeInMemory(text, params) {
        ...
        // --- TRANSACTIONS ---
            ...
            const matched = this.memoryStore.transactions.filter((t) => t.merchantId === merchantId && t.status === 'SUCCESS');
            ...
            rows.push({ hourOfDay: 8, txnCount: 18, revenue: 4200.0 }, { hourOfDay: 9, txnCount: 28, revenue: 7800.0 }, { hourOfDay: 10, txnCount: 22, revenue: 6100.0 }, { hourOfDay: 18, txnCount: 35, revenue: 9900.0 }, { hourOfDay: 19, txnCount: 42, revenue: 12400.0 }, { hourOfDay: 20, txnCount: 38, revenue: 10500.0 });
        }
        ...
        // --- HEALTH SCORES ---
            ...
            if (matched.length > 0)
                rows.push(matched[matched.length - 1]);
        }
        // --- CREDIT ELIGIBILITY ---
